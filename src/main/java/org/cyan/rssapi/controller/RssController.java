...
public class RssController {
    ...
    public String analyzeRssResources(@RequestParam @ApiParam(name = "urls", value = "List of comma separated urls") String[] urls)
    ...
    @ApiOperation(
            value = "Retrieves three topmost hot topics based on a previous analysis, stored under specific identifier, given as an input argument.",
            response = HotRssResponse.class)
    @GetMapping("/frequency")
    public List<HotRssResponse> getMostFrequent(@RequestParam @ApiParam(name = "id", value = "Unique identifier") String id) {
